                                ...
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-exampl">                                
                                    ...
                                    while ($personal=$resultado->fetch(PDO::FETCH_ASSOC)){                                                   
                                        echo "<tr class='odd gradeX'>";
                                            echo "<td align='center' class='bot'><button type='button' value='". $personal['id'] . " ' class='btn btn-success btn-circle' onclick='filterInputs(this.value);' data-toggle='modal' data-target='#myModal1' data-toggle='tooltip' data-placement='top' title='Agregar manualmente'>" . $personal['calificacionCall'] . "</button></td>";                                            
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">                                        
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form method="POST" action="evaluacion_update.php">
                                                <input class="form-control" value="<?php echo $personal2['id']; ?>"  name="id" type="hidden">  
                                                <div class="form-group">
                                                    <label for="disabledSelect">calificacion</label>
                                                    <select class="form-control postulacion1" name="calificacionCall" >
                                                        <option <?php if ($personal2['calificacionCall']==1){echo 'selected';} ?>>1</option>
                                                        <option <?php if ($personal2['calificacionCall']==2){echo 'selected';} ?>>2</option>
                                                        <option <?php if ($personal2['calificacionCall']==3){echo 'selected';} ?>>3</option>
                                                        <option <?php if ($personal2['calificacionCall']==4){echo 'selected';} ?>>4</option>
                                                        <option <?php if ($personal2['calificacionCall']==5){echo 'selected';} ?>>5</option>
                                                    </select>
                                                </div>  
                                                <div class="form-group">
                                                   <label>Observaciones</label>
                                                   <textarea name="observacionesCall" class="form-control" rows="3"><?php echo $personal2['observacionesCall']; ?></textarea>
                                                </div>
