                ...
                <div class="col-lg-12">   
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            <a href="aspirante_estado.php?estado=HV_aceptadaHR&id_users=<?php echo $datosUser['id']; ?>&cant_cargos=<?php echo $cant_cargos; ?>"><button type="button" class="btn btn-success">Aceptar</button></a>
                        </div>            
