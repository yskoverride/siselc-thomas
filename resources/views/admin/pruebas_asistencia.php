        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Listado de Pruebas Verificar Asistencia</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-exampl">                                
                                ...
                                <?php while ($registro=$resultado->fetch(PDO::FETCH_ASSOC)){
                                    echo "<tr class='odd gradeX'>";
                                        ...
                                        echo "<td class='bot'><a href='personal_asistencia.php?id_prueba=" . $registro['id'] . "'><button type='button' class='btn btn-success'>Verificar</button></a></td>";
                                    echo "</tr>";                               
                                }
                                ?>
                                </tbody>
